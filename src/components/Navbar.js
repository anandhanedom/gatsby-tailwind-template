        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center py-4">
          ...
          <div className="items-center md:flex">
            ...
            <div className="flex items-center py-2 -mx-1 md:mx-0">
              <Link
                className="rounded-sm block px-8 py-4 mx-1 font-medium leading-5 text-center text-white transition-colors duration-200 transform bg-primary-100 hover:bg-opacity-90 md:mx-0 md:w-auto"
                to="/contact"
              >
                Contact
              </Link>
